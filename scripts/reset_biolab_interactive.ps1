...
$resultFile = Join-Path $repoRoot ".run\reset.result.json"
$runner = Join-Path $PSScriptRoot "reset_biolab.py"
$taskName = "SafeExec-BioLab-Reset"
...
Write-Host "Requested BioLab reset in the desktop session."
